  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Halaman Untuk Absensi Keluar</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            ...
            <div class="card-body">
              <form action="{{ route('ubah-absensi')}}" method="post">
                ...
                <div class="form-group">
                  <center>
                  <label id="clock" style="font-size: 100px; color: #659980; -webkit-text-stroke: 3px #00ACFE;
                ...
                <center>
                  <div class="form-group">
                    <button type="submit" class="btn btn-primary mt-3">Klik untuk Absensi Keluar</button>
                  </div>
                </center>
              </form>
