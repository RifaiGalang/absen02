                                ...
                                <form action="{{ url('update-pegawai') }}" method="post">
                                    ...
                                    <div class="form-group">
                                        <select class="form-select" name="level"
                                            ...
                                            <option value="{{ $d->level == 'admin' }}">{{ $d->level }}</option>
                                            <option value="{{ $d->level == 'pegawai' }}">{{ $d->level }}</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <input type="email" id="email" name="email"
                                            value="{{ $d->email }}" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <input type="password" value="{{ $d->password }}" id="password"
